...
Simple linear regression models attempt to predict the value
of some observed outcome random variable $\boldsymbol{Y}$ as
a linear function of a predictor random variable
$\boldsymbol{X}$.
