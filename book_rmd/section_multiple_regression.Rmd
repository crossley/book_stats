...
- It's powerful to write these equations in matrix form (the
  last line above) because it highlights how the two
  situations are essentially the same --- at least
  mathematically.
